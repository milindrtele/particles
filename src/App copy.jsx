...
//import simFragment from "./shaders/fbo/simFragment_simplex_noise.glsl";
  ...
  function setUpFbo() {
    ...
    for (let i = 0; i < size; i++) {
      for (let j = 0; j < size; j++) {
        ...
        data[index + 2] = -1 * imageDataArray[index + 0] * 50; //Math.random() - 0.5; // Z between -0.5 and 0.5
        data[index + 3] = imageDataArray[index + 1] * 50; // Alpha
      }
    }
